...
public class BrinjalPlantAdapter extends RecyclerView.Adapter<BrinjalPlantAdapter.viewHolder> {

    Context context;
    ArrayList<PlantModel> arrayList;

    public BrinjalPlantAdapter(Context context, ArrayList<PlantModel> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }

    @Override
    public  BrinjalPlantAdapter.viewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.brinjal_plant_item_list, viewGroup, false);
    ...
    public class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(View itemView) {
            super(itemView);
            icon = (ImageView) itemView.findViewById(R.id.brinjalPlant);
            iconData = (TextView) itemView.findViewById(R.id.titleDataBrinjal);
            cardView = (CardView) itemView.findViewById(R.id.cardViewPlantBrinjal);
        }
    }
